...
export const data: FileSchema = {
  ...
  "16": {
    ...
    tips: [
      ...
      {
        text: {
          de: "Profiling mit der Zielsetzung der Feststellung der vorhandenen Kenntnisse und Fähigkeiten, der Eignung für berufliche Tätigkeiten aus allen Berufszweigen: - Aktuelle Situation auf dem Arbeitsmarkt - Erhebung der persönlichen und berufsrelevanten Daten - Eignungsabklärung durch Gegenüberstellung des erarbeiteten Bewerberprofils mit dem aktuellen Anforderungsprofil des jeweiligen Berufsbildes - Objektivität der Selbsteinschätzung",
          en: "Profiling with the aim of determining the existing knowledge and skills, the suitability for professional activities from all occupational fields: - Current situation on the labor market - Collection of personal and professionally relevant data - Suitability clarification by comparing the developed applicant profile with the current requirement profile of the respective occupational profile - Objectivity of the self-assessment.",
        },
        subjectAreas: [5],
      },
      {
        text: {
          de: "Transferberatung nach dem Profiling: - Befähigung zur eigenständigen, angemessenen und wirkungsvollen Reaktion auf die Anforderungen des Arbeitsmarktes - Einzelberatung / Besprechung des Profilingbogens / Aktivierung / Motivation / gemeinsame Zielvereinbarung / Coaching / Folgegespräche / individuelles Vermittlungscoaching und individueller Bewerbungsstrategien",
          en: "Transfer counseling after profiling: - empowerment to respond independently, appropriately and effectively to the demands of the labor market - individual counseling / discussion of the profiling sheet / activation / motivation / joint agreement on goals / coaching / follow-up interviews / individual placement coaching and individual application strategies.",
        },
        subjectAreas: [5],
      },
      {
  ...
  "21": {
    ...
    tips: [
      ...
      {
        text: {
          de: "Inhalte für einen Vertrag      - Ziele, Inhalte und Angaben zur Art des Abschlusses      - Dauer der Maßnahme, Hinweis zum Urlaubsanspruch bei Maßnahmen, die länger als 6 Monate dauern.      - Kosten (inkl. Angaben zu der Höhe der Lehrgangsgebühren, Kosten für Arbeitskleidung, Lernmittel und Prüfungsstücke mit Hinweis zum Verbleib beim Teilnehmenden (oder Leihweise), Prüfungsgebühren, Zahlungsweise      - Mitgeltende Dokumente (AGBs, Datenschutzvereinbarung, Hausordnung, Fehlzeitenregelung usw.) müssen dem Vertrag beigefügt werden.      - Rechte und Pflichten der Vertragspartner      - Angemessene Rücktrittsbedingungen vor Beginn der Maßnahme: Dem Teilnehmenden muss für den Fall, dass eine Förderung nach dem SGB III nicht erfolgt, bzw. bei Arbeitsaufnahme ein Rücktrittsrecht eingeräumt werden. Kosten dürfen hierbei nicht entstehen. Zusätzlich ist ein allgemeines Rücktrittsrecht innerhalb von 14 Tage nach Vertragsabschluss, längstens bis zum Beginn der Maßnahme einzuräumen.      - Angemessene Kündigungsbedingungen während der Maßnahme: Die Teilnahme an einer Maßnahme der Arbeitsmarktdienstleistung muss mit einer Frist von höchstens 6 Wochen, erstmals zum Ende der ersten 3 Monate, sodann jeweils zum Ende der nächsten 3 Monate kündbar sein. Sofern eine Maßnahme in Abschnitten/Modulen kürzer als 3 Monate sind, angeboten wird, muss eine Kündigung zum Ende eines jeden Abschnitts/Moduls möglich sein.      - Hinweis, dass dem Teilnehmenden nach Abschluss der Maßnahme eine Teilnahmebescheinigung mit Angaben zum Inhalt, zeitlichen Umfang und Ziel der Maßnahme ausgehändigt wird, unabhängig davon, ob der Teilnehmende mit Erfolg die Maßnahme abgeschlossen oder vorzeitig die Maßnahme beendet hat.      - Informationspflicht bei Erhebung von personenbezogenen Daten gemäß Kap. 3 Art. 13 der Datenschutzgrundverordnung (DSGVO)",
